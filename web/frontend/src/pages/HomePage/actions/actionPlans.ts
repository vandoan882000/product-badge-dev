...
export const actionGetPlans = createAsyncAction([
  '@Plans/getPlansRequest',
  '@Plans/getPlansSuccess',
  '@Plans/getPlansFailure',
])<undefined, { data: PlanAPIResponseData[] }, undefined>();
...
])<undefined, { currentPlan: string }, undefined>();

export const useGetCurrentPlan = createDispatchAsyncAction(actionGetCurrentPlan);

export const actionGetPromoCode = createAsyncAction([
  '@Plans/GetPromoCodeRequest',
  '@Plans/GetPromoCodeSuccess',
  '@Plans/GetPromoCodeFailure',
])<{ code: string }, { coupon: string; couponID: string; percentage: string; messageCoupon: string }, undefined>();
